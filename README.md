...
## Installation:
Copy the following link into your Manifest URL bar in the Module Installation window of Foundry VTT: https://github.com/rune-goblin/pf2e-repeated-skill-challenge/releases/latest/download/module.json
